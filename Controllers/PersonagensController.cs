    ...
    public class PersonagensController : ControllerBase
    {
        ...
        public async Task<IActionResult> ZerarRankingAsync(Personagem p)
        {
            try
            {
                ...
                int linhasAfetadas = 0;
                bool atualizou = await TryUpdateModelAsync<Personagem>(pEncontrado, "p", pAtualizar => pAtualizar.Disputas, pAtualizar => pAtualizar.Vitorias, pAtualizar => pAtualizar.Derrotas);
                // EF vai detectar e atualizar apenas as colunas que foram alteradas.
                if (atualizou)
